...
while True:
    ...
    while (id != int(atm.checkPin()) and trial < 3):
        ...
        if trial == 3:
            ...
            exit ()
    while True:
        print('"Selamat datang di ATM Firdaus..')
        ...
        if selectmenu == 1:
            ...
            verify_withdraw = input('Konfirmasi: Anda akan melakukan debet dengan nominalberikut ? y/n ' + str(nominal) + ' ')
            ...
            print('Terima kasih telah menggunakan ATM Firdaus!')
            exit()
        else:
